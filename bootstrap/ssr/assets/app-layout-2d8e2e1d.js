...
function MenuAdministrator() {
  ...
  return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("ul", { role: "list", className: "-mx-2 space-y-1", children: [
    ...
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Aplikasi" }) }),
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, { href: route("websites.index"), className: classNames(route().current("websites*") ? "bg-gray-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600", "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"), children: [
      /* @__PURE__ */ jsx(Icon, { icon: "IconChartPie3" }),
      "Websites"
    ] }) }),
    /* @__PURE__ */ jsx(Separator, { className: "!my-4" }),
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Payment" }) }),
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, { href: "#", className: classNames(route().current("websites*") ? "bg-gray-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600", "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"), children: [
      /* @__PURE__ */ jsx(Icon, { icon: "IconChartPie3" }),
      "Billing"
    ] }) }),
    /* @__PURE__ */ jsx(Separator, { className: "!my-4" }),
    ...
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, { href: "#", className: classNames(route().current("ticket_bromo*") ? "bg-gray-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600", "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"), children: [
      /* @__PURE__ */ jsx(Icon, { icon: "IconChartPie3" }),
      "Users"
    ] }) }),
    /* @__PURE__ */ jsx(Separator, { className: "!my-4" }),
